...
class JavScraper:
    ...
    def __gen_movie_nfo_file(self,
        ...
        # 发布日期
        DomUtils.add_node(doc, root, "premiered", (mediainfo.release_date or "") + " 00:00:00")
        DomUtils.add_node(doc, root, "releasedate", (mediainfo.release_date or "")  + " 00:00:00")
        # 年份
                    ...
                    if not is_poster:
                        ...
                        if badge:
                            ...
                            if not badge_path.exists():
                                badge_path.write_bytes(RequestUtils().get_res(url="https://oss-game88.oss-cn-beijing.aliyuncs.com/js_plugs/album/202210/zimu.png", raise_exception=True).content)
